...
void updateBall(screen *scrn, ball *b, paddle *p, brick *bk) {
    ...
    //     && b->y <= bk->y + bk->height
    //     && b->x + b->size + 1 >= bk->x
    //     && b->x <= bk->x + bk->length) && (bk->state == 1)) {
    //     bk->state = 0;
    //     b->dy = -b->dy;
    //     score++;
    // }
    // bottom
    // else if ((b->y <= bk->y + bk->height) && (bk->state == 1)) {
    //     bk->state = 0;
    //     b->dy = -b->dy;
    //     score++;
    // }
    // left
    // else if ((b->x + b->size + 1 >= bk->x && b->x <= bk->x + bk->length) && (bk->state == 1)) {
    //     bk->state = 0;
    //     b->dx = -b->dx;
    //     score++;
    // }
    // right
    // else if ((b->x <= bk->x + bk->length) && (bk->state == 1)) {
    //     bk->state = 0;
    //     b->dx = -b->dx;
    //     score++;
    // }
